...
const HeroSection = () => {
  ...
  // Pindahkan handleNext dan handlePrevious ke dalam useEffect terpisah
  useEffect(() => {
  ...
  return (
    <div className="relative h-[90vh] w-full overflow-hidden bg-black">
      ...
      {/* Navigation Buttons - Perbaikan pada z-index dan pointer events */}
        ...
        <div className="relative h-full container mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
                <div className="max-w-3xl space-y-6">
                  ...
                  <div className="flex flex-wrap gap-4 pt-4">
                    <button className="group bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-all duration-300 hover:scale-105">
                      <Play className="w-5 h-5 group-hover:animate-pulse" />
                      <span className="font-medium">Tonton Trailer</span>
                    </button>
                    <button className="group bg-gray-800/80 hover:bg-gray-700 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-all duration-300 hover:scale-105">
      ...
      {/* Enhanced Indicators - Tambahkan z-index */}
